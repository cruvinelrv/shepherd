...
const List<SyncFileConfig> syncedFiles = [
  SyncFileConfig(path: 'dev_tools/shepherd/feature_toggles.yaml', requiredSync: true),
  SyncFileConfig(path: 'dev_tools/shepherd/config.yaml', requiredSync: true),
  SyncFileConfig(path: 'dev_tools/shepherd/environments.yaml', requiredSync: true),
